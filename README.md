...
* cuda `11.8`
* gurobipy `10.0.0`
* pycddlib `2.1.7` (**Important**: pycddlib Version 3.0.0 onward causes [backward incompatibility issue](https://pycddlib.readthedocs.io/en/latest/changes.html) in pypoman source code, so make sure you are not using any of those versions. We thank [@apric0ts](https://apric0ts.github.io/) for help identifying this dependency problem)
